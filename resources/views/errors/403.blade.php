		...
		<div class="bg-white p-3 fixed-bottom border-top shadow">
			<div class="d-flex align-items-center justify-content-between flex-wrap">
				<ul class="list-inline mb-0">
					...
					<li class="list-inline-item"><a href="{{ asset($setting->facebook) }}"><i class='bx bxl-facebook me-1'></i>Facebook</a>
					</li>
					<li class="list-inline-item"><a href="{{ asset($setting->instagram) }}"><i class='bx bxl-instagram me-1'></i>instagram</a>
					</li>
				</ul>
				<p class="mb-0">{{ asset($setting->copyright) }}</p>
			</div>
		</div>
	</div>
	<!-- end wrapper -->
