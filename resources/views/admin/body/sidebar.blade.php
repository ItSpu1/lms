...
{{-- //agha --}}
		{{-- @if (Auth::user()->can('category.menu'))(SPATIE Site) if user has this permission it will be disabled on dashboard --}}
		<li>
		...
		<li>
			...
			<ul>
				<li> <a href="{{ route('all.permission') }}"><i class='bx bx-radio-circle'></i>ِAll Permission</a>
				</li>
				<li> <a href="{{ route('all.roles') }}"><i class='bx bx-radio-circle'></i>ِAll Roles</a>
				</li>
