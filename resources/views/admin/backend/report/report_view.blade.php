...
<div class="page-content">
    ...
    <div class="card">
                ...
                <div class="col-md-4 ">
                    ...
                    <form id="myForm" action="{{ route('search.by.date') }}" method="post" class="row g-3" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-12">
                            <label for="input1" class="form-label"> Serach By Date</label>
        ...
        <form id="myForm" action="{{ route('search.by.month') }}" method="post" class="row g-3" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-12">
                <label for="input1" class="form-label"> Serach By Month</label>
            ...
            <div class="form-group col-md-12">
                <label for="input1" class="form-label"> Serach By Year</label>
