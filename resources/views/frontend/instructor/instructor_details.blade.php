    ...
    <div class="bg-gray py-5">
        ...
        <div id="app">
            <send-message :receiverid="{{ $instructor->id }}" receivername="{{ $instructor->name }}"></send-message>
                ...
                @else
                <button class="btn theme-btn d-none d-lg-inline-block">Login First                    
                </button>
                @endauth
...
<div class="tooltip_templates">
    <div id="tooltip_content_1{{$item->id}}">
        ...
        @php
            $goals = App\Models\Course_goals::where('course_id',$item->id)->orderBy('id','DESC')->get();
        @endphp
